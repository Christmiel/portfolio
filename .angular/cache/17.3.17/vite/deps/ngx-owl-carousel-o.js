import {
  ...
  NavigationEnd,
  Router
} from "./chunk-YHGWVCII.js";
import "./chunk-JLP2YQKT.js";
import "./chunk-YSFXRHOA.js";
import {
  CommonModule,
  LocationStrategy,
  NgClass,
...
function StageComponent_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(1, slide_r2.load ? 1 : -1);
  }
}
var _c3 = ["dot"];
var _c4 = ["navBtn"];
...
function CarouselComponent_Conditional_6_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("aria-label", "Carousel Dot " + (i_r7 + 1))("aria-current", dot_r6.active ? "true" : null)("tabindex", ctx_r2.defineTabIndexForDots(dot_r6));
    ɵɵadvance(2);
...
var CarouselSlideDirective = class _CarouselSlideDirective {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    inputs: {
      ...
      dataMerge: [InputFlags.SignalBased, "dataMerge"],
      width: [InputFlags.SignalBased, "width"],
      dotContent: [InputFlags.SignalBased, "dotContent"],
      dataHash: [InputFlags.SignalBased, "dataHash"]
    }
  });
};
(() => {
...
var StageComponent = class _StageComponent {
  ...
  */
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      owlDraggable: [InputFlags.SignalBased, "owlDraggable"],
      stageData: [InputFlags.SignalBased, "stageData"],
      slidesData: [InputFlags.SignalBased, "slidesData"]
    },
    decls: 4,
    vars: 7,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function CarouselComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(3, CarouselComponent_Conditional_3_Template, 2, 5, "button", 5)(4, CarouselComponent_Conditional_4_Template, 2, 6, "div", 6)(5, CarouselComponent_Conditional_5_Template, 2, 5, "button", 7);
        ɵɵelementEnd();
        ɵɵtemplate(6, CarouselComponent_Conditional_6_Template, 3, 3, "div", 8);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        let tmp_1_0;
        ...
        ɵɵadvance(3);
        ɵɵconditional(3, ctx.slides.toArray().length && !((tmp_2_0 = ctx.navData()) == null ? null : tmp_2_0.disabled) ? 3 : -1);
        ɵɵadvance();
        ɵɵconditional(4, ctx.carouselLoaded() ? 4 : -1);
        ɵɵadvance();
        ɵɵconditional(5, ctx.slides.toArray().length && !((tmp_4_0 = ctx.navData()) == null ? null : tmp_4_0.disabled) ? 5 : -1);
        ɵɵadvance();
        ɵɵconditional(6, ctx.slides.toArray().length ? 6 : -1);
      }
    },
